#added test for converting to psi
...
def test_pressure_loss_from_pipe():
    ...
    assert pressure_loss_from_pipe(0.048692,200.0,0.00,1.75) == approx(0.000, abs=0.001)
...
def test_convert_kpa_to_psi():
    assert convert_kpa_to_psi(205.8) == approx(29.848,abs=0.001)
    assert convert_kpa_to_psi(14.8) == approx(2.146, abs = 0.001)
    assert convert_kpa_to_psi(1026.8) == approx(148.925, abs=0.001)
