#adding global variables, and converting to psi
gravity = 9.8066500
density = 998.2000000
...
def pressure_loss_from_fittings(
    ...
    pressure_loss = (-.04*density*fluid_velocity**2*quantity_fittings)/2000
    return pressure_loss
...
def pressure_loss_from_pipe_reduction(larger_diameter,
    ...
    pressure_loss = (-constant*density*fluid_velocity**2)/2000
    return pressure_loss
#converting to psi
